...
import { IEnqueueSnackbar } from "../../actions";

interface Props extends WithSnackbarProps {
    notifications: IEnqueueSnackbar["notification"][];
...
class Notifier extends Component<Props> {
    ...
    shouldComponentUpdate({ notifications: newSnacks = [] as IEnqueueSnackbar["notification"][] }) {
